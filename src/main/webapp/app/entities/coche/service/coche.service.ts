...
export class CocheService {
  ...
  cochesExpuestos(expo: boolean, req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<ICoche[]>(`${this.resourceUrl}/expuestos/${String(expo)}`, { params: options, observe: 'response' });
  }
