...
class CocheResourceIT {
    ...
    private static final Boolean DEFAULT_EXPUESTO = false;
    private static final Boolean UPDATED_EXPUESTO = true;
    ...
    void createCoche() throws Exception {
        ...
        assertThat(testCoche.getExpuesto()).isEqualTo(DEFAULT_EXPUESTO);
    }
    ...
    void getAllCoches() throws Exception {
        ...
        restCocheMockMvc
            ...
            .andExpect(jsonPath("$.[*].expuesto").value(hasItem(DEFAULT_EXPUESTO.booleanValue())));
    }
    ...
    void getCoche() throws Exception {
        ...
        restCocheMockMvc
            ...
            .andExpect(jsonPath("$.expuesto").value(DEFAULT_EXPUESTO.booleanValue()));
    }
    ...
    void putNewCoche() throws Exception {
        ...
        assertThat(testCoche.getExpuesto()).isEqualTo(UPDATED_EXPUESTO);
    }
    ...
    void partialUpdateCocheWithPatch() throws Exception {
        ...
        partialUpdatedCoche.modelo(UPDATED_MODELO).expuesto(UPDATED_EXPUESTO);
