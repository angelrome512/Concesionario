...
class VentaResourceIT {
    ...
    private static final String DEFAULT_TIPOPAGO = "AAAAAAAAAA";
    private static final String UPDATED_TIPOPAGO = "BBBBBBBBBB";
    ...
    public static Venta createEntity(EntityManager em) {
        Venta venta = new Venta().fecha(DEFAULT_FECHA).tipopago(DEFAULT_TIPOPAGO).total(DEFAULT_TOTAL);
        return venta;
    }
    ...
    public static Venta createUpdatedEntity(EntityManager em) {
        Venta venta = new Venta().fecha(UPDATED_FECHA).tipopago(UPDATED_TIPOPAGO).total(UPDATED_TOTAL);
        return venta;
    }
    ...
    void createVenta() throws Exception {
        ...
        assertThat(testVenta.getTipopago()).isEqualTo(DEFAULT_TIPOPAGO);
    ...
    void getAllVentas() throws Exception {
        ...
        restVentaMockMvc
            ...
            .andExpect(jsonPath("$.[*].tipopago").value(hasItem(DEFAULT_TIPOPAGO)))
    ...
    void getVenta() throws Exception {
        ...
        restVentaMockMvc
            ...
            .andExpect(jsonPath("$.tipopago").value(DEFAULT_TIPOPAGO))
    ...
    void putNewVenta() throws Exception {
        ...
        updatedVenta.fecha(UPDATED_FECHA).tipopago(UPDATED_TIPOPAGO).total(UPDATED_TOTAL);
        ...
        assertThat(testVenta.getTipopago()).isEqualTo(UPDATED_TIPOPAGO);
    ...
    void partialUpdateVentaWithPatch() throws Exception {
        ...
        partialUpdatedVenta.tipopago(UPDATED_TIPOPAGO);
    ...
    void fullUpdateVentaWithPatch() throws Exception {
        ...
        partialUpdatedVenta.fecha(UPDATED_FECHA).tipopago(UPDATED_TIPOPAGO).total(UPDATED_TOTAL);
